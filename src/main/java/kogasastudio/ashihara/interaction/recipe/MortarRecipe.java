    ...
    public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<MortarRecipe> {
        ...
        public MortarRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            if (inputIn.isEmpty()) {
                ...
                throw new JsonParseException("Too many ingredients for mortar recipe! The max is 4");
            } else {
                ...
                if (recipeTypeIn != 2 && sequenceIn.length < 1) {
                    throw new JsonParseException("No sequence provided!");
                } else {
                    ...
                    if (json.has("fluid")) {
                        ...
                        return new MortarRecipe(recipeId, groupIn, inputIn, outputIn, FluidStack.EMPTY, progressIn, recipeTypeIn, sequenceIn);
                }
            }
        }
        ...
        public MortarRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
            ...
            if (nbt != null) ContainerHelper.loadAllItems(nbt, outputItemsIn);
