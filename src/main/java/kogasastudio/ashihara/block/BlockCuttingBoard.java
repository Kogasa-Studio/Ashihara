...
public class BlockCuttingBoard extends Block
{
    ...
    public InteractionResult use(BlockState state, Level worldIn, BlockPos pos, Player player, InteractionHand handIn, BlockHitResult hit)
    {
        ...
        if (teIn == null || !teIn.getType().equals(TERegistryHandler.CUTTING_BOARD_TE.get())) return InteractionResult.FAIL;
    ...
    @Override
    public BlockEntity createTileEntity(BlockState state, BlockGetter world) {return new CuttingBoardTE();}
}
