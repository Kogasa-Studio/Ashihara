...
public class ItemRegistryHandler
{
    ...
    public static final RegistryObject<Item> PESTLE = ITEMS.register("pestle", () -> new Item(new Item.Properties().durability(256)));
    public static final RegistryObject<Item> SUJIKABUTO = ITEMS.register("sujikabuto", ItemSujikaButo::new);

    //食物
    public static final RegistryObject<Item> SAKURAMOCHI = ITEMS.register("sakuramochi", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(4).saturationMod(1).effect(() -> new MobEffectInstance(MobEffects.HEAL, 1, 2), 1.0F).build())));
    ...
    public static final RegistryObject<Item> CUCUMBER = ITEMS.register("cucumber", () -> new ItemNameBlockItem(BlockRegistryHandler.CUCUMBERS.get(), new Item.Properties().food(new FoodProperties.Builder().nutrition(2).build())));
    public static final RegistryObject<Item> TOMATO = ITEMS.register("tomato", () -> new EasyFood(2));
    public static final RegistryObject<Item> SWEET_POTATO = ITEMS.register("sweet_potato", () -> new ItemNameBlockItem(BlockRegistryHandler.SWEET_POTATOES.get(), new Item.Properties().food(new FoodProperties.Builder().nutrition(2).build())));
    ...
    //工具
    public static final RegistryObject<Item> TACHI = ITEMS.register("tachi", () -> new SwordItem(Tiers.DIAMOND, 15, 4.0f, new Item.Properties()));
    ...
    //材料
    public static final RegistryObject<Item> SAKURA = ITEMS.register("sakura", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(1).effect(() -> new MobEffectInstance(MobEffects.HEAL, 1, 1), 1.0F).build())));
    public static final RegistryObject<Item> SAKURA_PETAL = ITEMS.register("sakura_petal", AshiharaMaterial::new);
    public static final RegistryObject<Item> DIRT_BALL = ITEMS.register("dirt_ball", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(2).effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 400, 2), 1.0F).build())));
    ...
    public static final RegistryObject<Item> SOY_BEAN = ITEMS.register("soy_bean", () -> new ItemNameBlockItem(BlockRegistryHandler.SOY_BEANS.get(), new Item.Properties()));
    ...
    public static final RegistryObject<Item> TEA_SEED = ITEMS.register("tea_seeds", () -> new ItemNameBlockItem(BlockRegistryHandler.TEA_TREE.get(), (new Item.Properties())));
    ...
    public static final RegistryObject<Item> DIRT_DEPRESSION = ITEMS.register("dirt_depression", () -> new BlockItem(BlockRegistryHandler.DIRT_DEPRESSION.get(), new Item.Properties()));
    public static final RegistryObject<Item> WATER_FIELD = ITEMS.register("water_field", () -> new BlockItem(BlockRegistryHandler.WATER_FIELD.get(), new Item.Properties()));
    public static final RegistryObject<Item> CHERRY_SAPLING = ITEMS.register("cherry_sapling", () -> new BlockItem(BlockRegistryHandler.CHERRY_SAPLING.get(), new Item.Properties()));
    public static final RegistryObject<Item> RED_MAPLE_SAPLING = ITEMS.register("red_maple_sapling", () -> new BlockItem(BlockRegistryHandler.RED_MAPLE_SAPLING.get(), new Item.Properties()));
    public static final RegistryObject<Item> TETSUSENCHI = ITEMS.register("tetsusenchi", () -> new BlockItem(BlockRegistryHandler.TETSUSENCHI.get(), new Item.Properties()));
    public static final RegistryObject<Item> MORTAR = ITEMS.register("mortar", () -> new BlockItem(BlockRegistryHandler.MORTAR.get(), new Item.Properties()));
    public static final RegistryObject<Item> MILL = ITEMS.register("mill", () -> new BlockItem(BlockRegistryHandler.MILL.get(), new Item.Properties()));
    public static final RegistryObject<Item> CHRYSANTHEMUM = ITEMS.register("chrysanthemum", () -> new BlockItem(BlockRegistryHandler.CHRYSANTHEMUM.get(), new Item.Properties()));
    public static final RegistryObject<Item> REED = ITEMS.register("reed", () -> new BlockItem(BlockRegistryHandler.REED.get(), new Item.Properties()));
    public static final RegistryObject<Item> SHORTER_REED = ITEMS.register("shorter_reed", () -> new BlockItem(BlockRegistryHandler.SHORTER_REED.get(), new Item.Properties()));
    public static final RegistryObject<Item> HYDRANGEA_BUSH = ITEMS.register("hydrangea_bush", () -> new BlockItem(BlockRegistryHandler.HYDRANGEA_BUSH.get(), new Item.Properties()));
    ...
    //木制品
    public static final RegistryObject<Item> CHERRY_LOG = ITEMS.register("cherry_log", () -> new BlockItem(BlockRegistryHandler.CHERRY_LOG.get(), new Item.Properties()));
    public static final RegistryObject<Item> STRIPPED_CHERRY_LOG = ITEMS.register("stripped_cherry_log", () -> new BlockItem(BlockRegistryHandler.STRIPPED_CHERRY_LOG.get(), new Item.Properties()));
    public static final RegistryObject<Item> CHERRY_WOOD = ITEMS.register("cherry_wood", () -> new BlockItem(BlockRegistryHandler.CHERRY_WOOD.get(), new Item.Properties()));
    public static final RegistryObject<Item> CHERRY_PLANKS = ITEMS.register("cherry_planks", () -> new BlockItem(BlockRegistryHandler.CHERRY_PLANKS.get(), new Item.Properties()));
    public static final RegistryObject<Item> CHERRY_STAIRS = ITEMS.register("cherry_stairs", () -> new BlockItem(BlockRegistryHandler.CHERRY_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<Item> CHERRY_SLAB = ITEMS.register("cherry_slab", () -> new BlockItem(BlockRegistryHandler.CHERRY_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> CHERRY_FENCE = ITEMS.register("cherry_fence", () -> new BlockItem(BlockRegistryHandler.CHERRY_FENCE.get(), new Item.Properties()));
    public static final RegistryObject<Item> CHERRY_FENCE_GATE = ITEMS.register("cherry_fence_gate", () -> new BlockItem(BlockRegistryHandler.CHERRY_FENCE_GATE.get(), new Item.Properties()));
    public static final RegistryObject<Item> CHERRY_BUTTON = ITEMS.register("cherry_button", () -> new BlockItem(BlockRegistryHandler.CHERRY_BUTTON.get(), new Item.Properties()));

    public static final RegistryObject<Item> STRIPPED_RED_LOG = ITEMS.register("stripped_red_log", () -> new BlockItem(BlockRegistryHandler.STRIPPED_RED_LOG.get(), new Item.Properties()));
    public static final RegistryObject<Item> RED_PLANKS = ITEMS.register("red_planks", () -> new BlockItem(BlockRegistryHandler.RED_PLANKS.get(), new Item.Properties()));
    public static final RegistryObject<Item> RED_STAIRS = ITEMS.register("red_stairs", () -> new BlockItem(BlockRegistryHandler.RED_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<Item> RED_SLAB = ITEMS.register("red_slab", () -> new BlockItem(BlockRegistryHandler.RED_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> RED_FENCE = ITEMS.register("red_fence", () -> new BlockItem(BlockRegistryHandler.RED_FENCE.get(), new Item.Properties()));
    public static final RegistryObject<Item> RED_FENCE_GATE = ITEMS.register("red_fence_gate", () -> new BlockItem(BlockRegistryHandler.RED_FENCE_GATE.get(), new Item.Properties()));

    public static final RegistryObject<Item> MAPLE_LOG = ITEMS.register("maple_log", () -> new BlockItem(BlockRegistryHandler.MAPLE_LOG.get(), new Item.Properties()));
    public static final RegistryObject<Item> STRIPPED_MAPLE_LOG = ITEMS.register("stripped_maple_log", () -> new BlockItem(BlockRegistryHandler.STRIPPED_MAPLE_LOG.get(), new Item.Properties()));
    public static final RegistryObject<Item> MAPLE_WOOD = ITEMS.register("maple_wood", () -> new BlockItem(BlockRegistryHandler.MAPLE_WOOD.get(), new Item.Properties()));
    public static final RegistryObject<Item> MAPLE_PLANKS = ITEMS.register("maple_planks", () -> new BlockItem(BlockRegistryHandler.MAPLE_PLANKS.get(), new Item.Properties()));
    public static final RegistryObject<Item> MAPLE_STAIRS = ITEMS.register("maple_stairs", () -> new BlockItem(BlockRegistryHandler.MAPLE_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<Item> MAPLE_SLAB = ITEMS.register("maple_slab", () -> new BlockItem(BlockRegistryHandler.MAPLE_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> MAPLE_FENCE = ITEMS.register("maple_fence", () -> new BlockItem(BlockRegistryHandler.MAPLE_FENCE.get(), new Item.Properties()));
