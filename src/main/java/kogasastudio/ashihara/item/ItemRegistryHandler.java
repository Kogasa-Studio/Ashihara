...
public class ItemRegistryHandler
{
    ...
    public static final DeferredItem<Item> CHERRY_BLOSSOM_VINES = ITEMS.register("cherry_blossom_vines", () -> new BlockItem(BlockRegistryHandler.CHERRY_BLOSSOM_VINES.get(), new Item.Properties()));
