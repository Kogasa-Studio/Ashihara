                    ...
                    (
                            ...
                            () -> CreativeModeTab.builder()
                                    ...
                                    .displayItems(((itemDisplayParameters, output) ->
                                    {
                                        ...
                                        output.accept(Items.SPRUCE_RAFTER_PLANKS_1_1.get());
                                        output.accept(Items.SPRUCE_RAFTER_PLANKS_1_2.get());
                                        output.accept(Items.SPRUCE_RAFTER_PLANKS_WIDE.get());
                                        output.accept(Items.SPRUCE_RAFTER_PLANKS_WIDE_1_4.get());
                                        output.accept(Items.SPRUCE_RAFTER_PLANKS_QUARTER_1_2.get());
                                        output.accept(Items.SPRUCE_RAFTER_PLANKS_QUARTER_1_1.get());
                                        output.accept(Items.WHITE_RAFTER_PLANKS_1_1.get());
                                        output.accept(Items.WHITE_RAFTER_PLANKS_1_2.get());
                                        output.accept(Items.WHITE_RAFTER_PLANKS_WIDE.get());
                                        output.accept(Items.WHITE_RAFTER_PLANKS_WIDE_1_4.get());
                                        output.accept(Items.WHITE_RAFTER_PLANKS_QUARTER_1_2.get());
                                        output.accept(Items.WHITE_RAFTER_PLANKS_QUARTER_1_1.get());
                                        output.accept(Items.CYPRESS_ROOF.get());
                                        output.accept(Items.CYPRESS_ROOF_1_4.get());
                                        output.accept(Items.CYPRESS_ROOF_CORNER.get());
                                        output.accept(Items.CYPRESS_ROOF_QUARTER.get());
                                        output.accept(Items.CYPRESS_ROOF_QUARTER_1_2.get());
                                        output.accept(Items.CYPRESS_ROOF_QUARTER_1_1.get());
                                        output.accept(Items.CYPRESS_ROOF_QUARTER_CORNER.get());
                                        output.accept(Items.CYPRESS_ROOF_EDGE.get());
                                        output.accept(Items.CYPRESS_ROOF_EDGE_RIGHT.get());
                                        output.accept(Items.CYPRESS_ROOF_EDGE_LEFT.get());
                                        output.accept(Items.CYPRESS_ROOF_EDGE_RIGHT_1_4.get());
                                        output.accept(Items.CYPRESS_ROOF_EDGE_LEFT_1_4.get());
                                        output.accept(Items.CYPRESS_ROOF_EDGE_RIGHT_1_2.get());
                                        output.accept(Items.CYPRESS_ROOF_EDGE_LEFT_1_2.get());
                                        ...
                                        output.accept(Items.STONE_SACRED_FENCE.get());
                                        ...
                                        output.accept(Items.CYPRESS_ROOF_HALF_1_2.get());
                                        output.accept(Items.CYPRESS_ROOF_HALF_1_1.get());
