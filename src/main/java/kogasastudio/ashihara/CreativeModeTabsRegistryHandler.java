                    ...
                    (
                            ...
                            () -> CreativeModeTab.builder()
                                    ...
                                    .displayItems(((itemDisplayParameters, output) ->
                                    {
                                        ...
                                        output.accept(ItemRegistryHandler.RED_LATTICED_WINDOW_QUARTER.get());
                                        ...
                                        output.accept(ItemRegistryHandler.CYPRESS_ROOF_QUARTER_CORNER.get());
                                        output.accept(ItemRegistryHandler.CYPRESS_ROOF_EDGE.get());
                                        output.accept(ItemRegistryHandler.CYPRESS_ROOF_EDGE_CORNER.get());
                                        output.accept(ItemRegistryHandler.CYPRESS_ROOF_EDGE_LAYER_BOTTOM.get());
                                        output.accept(ItemRegistryHandler.CYPRESS_ROOF_EDGE_LAYER_TOP.get());
                                        output.accept(ItemRegistryHandler.CYPRESS_ROOF_HALF.get());
                                        output.accept(ItemRegistryHandler.CYPRESS_ROOF_TOP.get());
                                        output.accept(ItemRegistryHandler.FLAT_TERRACOTTA_TILE_ROOF.get());
                                        output.accept(ItemRegistryHandler.FLAT_TERRACOTTA_TILE_ROOF_HALF.get());
                                        output.accept(ItemRegistryHandler.FLAT_TERRACOTTA_TILE_ROOF_QUARTER.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_1_1.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_1_2.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_1_4.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_FLAT.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_1_1_HALF.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_1_2_HALF.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_1_4_HALF.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_FLAT_HALF.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_1_1_OBLIQUE.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_1_2_OBLIQUE.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_1_4_OBLIQUE.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_FLAT_OBLIQUE.get());
                                        output.accept(ItemRegistryHandler.TERRACOTTA_TILE_ROOF_EDGE.get());
                                        output.accept(ItemRegistryHandler.TERRACOTTA_TILE_ROOF_EDGE_CORNER.get());
                                        output.accept(ItemRegistryHandler.ROUND_TERRACOTTA_TILE_END.get());
                                        output.accept(ItemRegistryHandler.TERRACOTTA_TILE_ROOF_TOP.get());
                                        output.accept(ItemRegistryHandler.ROOF_TOP_TILES_PILE_1_1.get());
                                        output.accept(ItemRegistryHandler.ROOF_TOP_TILES_PILE_1_1_OBLIQUE.get());
                                        output.accept(ItemRegistryHandler.ROOF_TOP_TILES_PILE_1_2.get());
                                        output.accept(ItemRegistryHandler.ROOF_TOP_TILES_PILE_1_2_OBLIQUE.get());
                                        output.accept(ItemRegistryHandler.ROOF_TOP_TILES_PILE_1_4.get());
                                        output.accept(ItemRegistryHandler.ROOF_TOP_TILES_PILE_1_4_OBLIQUE.get());
                                        output.accept(ItemRegistryHandler.ROOF_TOP_TILES_PILE_FLAT.get());
                                        output.accept(ItemRegistryHandler.ROOF_TOP_TILES_PILE_FLAT_OBLIQUE.get());
