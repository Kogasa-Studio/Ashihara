...
public class CuttingBoardTER extends BlockEntityRenderer<CuttingBoardTE>
{
    public CuttingBoardTER(BlockEntityRenderDispatcher rendererDispatcherIn) {super(rendererDispatcherIn);}
