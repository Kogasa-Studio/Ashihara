...
public class GuideBookModel extends InternalControlGeoModel<GuideBookModel> implements SingletonGeoAnimatable
{
    ...
    public static final String ANIM_CLOSE_FROM_LEFT = "use.close_from_left";
    ...
    public static final String ANIM_CLOSE_FROM_RIGHT = "use.close_from_right";
    ...
    public static final RawAnimation CLOSE_FROM_LEFT = RawAnimation.begin().thenPlay(ANIM_CLOSE_FROM_LEFT);
    ...
    public static final RawAnimation CLOSE_FROM_RIGHT = RawAnimation.begin().thenPlay(ANIM_CLOSE_FROM_RIGHT);
    ...
    public static int totalPages = 170;
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllerRegistrar)
    {
        ...
        controllerRegistrar.add(new AnimationController<>(this, ANIM_OPEN_FROM_LEFT, animationState -> PlayState.STOP).triggerableAnim(ANIM_OPEN_FROM_LEFT, OPEN_FROM_LEFT));
        controllerRegistrar.add(new AnimationController<>(this, ANIM_OPEN_FROM_RIGHT, animationState -> PlayState.STOP).triggerableAnim(ANIM_OPEN_FROM_RIGHT, OPEN_FROM_RIGHT));
        controllerRegistrar.add(new AnimationController<>(this, ANIM_CLOSE_FROM_LEFT, animationState -> PlayState.STOP).triggerableAnim(ANIM_CLOSE_FROM_LEFT, CLOSE_FROM_LEFT));
        controllerRegistrar.add(new AnimationController<>(this, ANIM_CLOSE_FROM_RIGHT, animationState -> PlayState.STOP).triggerableAnim(ANIM_CLOSE_FROM_RIGHT, CLOSE_FROM_RIGHT));
        controllerRegistrar.add(new AnimationController<>(this, ANIM_FLIP_INITIAL_LEFT, animationState -> PlayState.STOP).triggerableAnim(ANIM_FLIP_INITIAL_LEFT, FLIP_INITIAL_LEFT));
        controllerRegistrar.add(new AnimationController<>(this, ANIM_FLIP_INITIAL_LEFT_S, animationState -> PlayState.STOP).triggerableAnim(ANIM_FLIP_INITIAL_LEFT_S, FLIP_INITIAL_LEFT_S));
        controllerRegistrar.add(new AnimationController<>(this, ANIM_FLIP_COMMON_LEFT, animationState -> PlayState.STOP).triggerableAnim(ANIM_FLIP_COMMON_LEFT, FLIP_COMMON_LEFT));
        controllerRegistrar.add(new AnimationController<>(this, ANIM_FLIP_FINAL_LEFT_S, animationState -> PlayState.STOP).triggerableAnim(ANIM_FLIP_FINAL_LEFT_S, FLIP_FINAL_LEFT_S));
        controllerRegistrar.add(new AnimationController<>(this, ANIM_FLIP_FINAL_LEFT, animationState -> PlayState.STOP).triggerableAnim(ANIM_FLIP_FINAL_LEFT, FLIP_FINAL_LEFT));
        ...
        controllerRegistrar.add(new AnimationController<>(this, ANIM_FLIP_INITIAL_RIGHT, animationState -> PlayState.STOP).triggerableAnim(ANIM_FLIP_INITIAL_RIGHT, FLIP_INITIAL_RIGHT));
        controllerRegistrar.add(new AnimationController<>(this, ANIM_FLIP_COMMON_RIGHT, animationState -> PlayState.STOP).triggerableAnim(ANIM_FLIP_COMMON_RIGHT, FLIP_COMMON_RIGHT));
        controllerRegistrar.add(new AnimationController<>(this, ANIM_FLIP_FINAL_RIGHT, animationState -> PlayState.STOP).triggerableAnim(ANIM_FLIP_FINAL_RIGHT, FLIP_FINAL_RIGHT));
    ...
    public static String getFlipAnim(int currentPageIndex, int nextPageIndex, int buffer)
    {
        ...
        if (currentPageIndex > 1 && currentPageIndex < totalPages - 2 && nextPageIndex == currentPageIndex + 1)
        {
            switch (buffer)
            {
        ...
        if (currentPageIndex == totalPages - 2 && nextPageIndex == totalPages - 1) return ANIM_FLIP_FINAL_LEFT_S;
        if (currentPageIndex == totalPages - 1 && nextPageIndex == totalPages) return ANIM_FLIP_FINAL_LEFT;
        if (currentPageIndex == totalPages && nextPageIndex > totalPages) return ANIM_CLOSE_FROM_LEFT;
        if (currentPageIndex > totalPages && nextPageIndex == totalPages) return ANIM_OPEN_FROM_RIGHT;
        if (currentPageIndex == totalPages && nextPageIndex == totalPages - 1) return ANIM_FLIP_INITIAL_RIGHT;
        if (currentPageIndex < totalPages - 1 && nextPageIndex == currentPageIndex - 1)
        {
            switch (buffer)
            {
        ...
        if (nextPageIndex == 0) return ANIM_CLOSE_FROM_RIGHT;
        return null;
    }
}
