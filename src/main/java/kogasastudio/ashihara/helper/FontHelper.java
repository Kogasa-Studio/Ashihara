...
{
    public static void renderFormattedText(PoseStack poseStack, String text, int x, int y, int color, boolean dropShadow, int maxWidth, MultiBufferSource bufferSource, Font.DisplayMode mode, int backgroundColor, int packedLight)
    {
