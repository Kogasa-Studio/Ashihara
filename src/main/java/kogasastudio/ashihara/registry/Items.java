...
public class Items
{
   ...
   public static final DeferredItem<? extends Item> CHOPSTICKS = ITEMS.registerItem("bamboo_chopsticks", properties -> new ChopsticksItem(properties.stacksTo(1)));
    ...
    public static final DeferredItem<? extends Item> RED_ROOF_EDGE_PLANKS = ITEMS.registerItem("red_roof_edge_planks", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_ROOF_EDGE_PLANKS, Blocks.RED_WOOD_COMPONENT, properties), Item.Properties::useItemDescriptionPrefix);
    public static final DeferredItem<? extends Item> RED_ROOF_EDGE_PLANKS_1_4 = ITEMS.registerItem("red_roof_edge_planks_1_4", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_ROOF_EDGE_PLANKS_1_4, Blocks.RED_WOOD_COMPONENT, properties), Item.Properties::useItemDescriptionPrefix);
    public static final DeferredItem<? extends Item> RED_ROOF_EDGE_PLANKS_1_2 = ITEMS.registerItem("red_roof_edge_planks_1_2", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_ROOF_EDGE_PLANKS_1_2, Blocks.RED_WOOD_COMPONENT, properties), Item.Properties::useItemDescriptionPrefix);
    public static final DeferredItem<? extends Item> RED_ROOF_EDGE_PLANKS_1_1 = ITEMS.registerItem("red_roof_edge_planks_1_1", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_ROOF_EDGE_PLANKS_1_1, Blocks.RED_WOOD_COMPONENT, properties), Item.Properties::useItemDescriptionPrefix);
