...
public class Items
{
    ...
    public static final DeferredItem<? extends Item> RED_ROOF_EDGE_PLANKS = ITEMS.registerItem("red_roof_edge_planks", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_ROOF_EDGE_PLANKS, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useItemDescriptionPrefix());
    ...
    //家具
    public static final DeferredItem<? extends Item> WOODEN_BOWL_MID = ITEMS.registerItem("wooden_bowl_mid", properties -> new FurnitureComponentItem(() -> FurnitureComponents.WOODEN_BOWL_MID, Blocks.MULTI_BUILT_BLOCK, properties), properties -> properties.useItemDescriptionPrefix());
