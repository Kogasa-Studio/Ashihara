...
public class Items
{
    ...
    public static final DeferredItem<? extends Item> MULTI_RED_THICK_COLUMN = ITEMS.registerItem("multi_red_thick_column", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_THICK_COLUMN, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_THICK_COLUMN_SHORT = ITEMS.registerItem("red_thick_column_short", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_THICK_COLUMN_SHORT, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_COLUMN = ITEMS.registerItem("red_column", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_COLUMN, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_COLUMN_SHORT = ITEMS.registerItem("red_column_short", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_COLUMN_SHORT, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_BEAM = ITEMS.registerItem("red_beam", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_BEAM, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_BEAM_CORNER = ITEMS.registerItem("red_beam_corner", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_BEAM_CORNER, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_CLAMP = ITEMS.registerItem("red_clamp", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_CLAMP, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_CLAMP_JOINT = ITEMS.registerItem("red_clamp_joint", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_CLAMP_JOINT, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_RAFTER_STICKING_BEAM = ITEMS.registerItem("red_rafter_sticking_beam", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_RAFTER_STICKING_BEAM, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_HIJIKI = ITEMS.registerItem("red_hijiki", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_HIJIKI, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_HIJIKI_SUPPORTER = ITEMS.registerItem("red_hijiki_supporter", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_HIJIKI_SUPPORTER, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_HIJIKI_CONNECTOR = ITEMS.registerItem("red_hijiki_connector", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_HIJIKI_CONNECTOR, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_HIJIKI_LONG = ITEMS.registerItem("red_hijiki_long", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_HIJIKI_LONG, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_HIJIKI_CORNER_NORMAL = ITEMS.registerItem("red_hijiki_corner_normal", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_HIJIKI_CORNER_NORMAL, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_HIJIKI_CORNER_LONG = ITEMS.registerItem("red_hijiki_corner_long", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_HIJIKI_CORNER_LONG, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_HANGING_STICKER = ITEMS.registerItem("red_hanging_sticker", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_HANGING_STICKER, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_HANGING_STICKER_CORNER = ITEMS.registerItem("red_hanging_sticker_corner", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_HANGING_STICKER_CORNER, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_TOU = ITEMS.registerItem("red_tou", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_TOU, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_TOU_OBLIQUE = ITEMS.registerItem("red_tou_oblique", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_TOU_OBLIQUE, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_ONI_TOU = ITEMS.registerItem("red_oni_tou", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_ONI_TOU, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_BIG_TOU = ITEMS.registerItem("red_big_tou", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_BIG_TOU, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> BASE_STONE = ITEMS.registerItem("base_stone", properties -> new BuildingComponentItem(() -> BuildingComponents.BASE_STONE, Blocks.STONE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> WHITE_SOIL_WALL = ITEMS.registerItem("white_soil_wall", properties -> new BuildingComponentItem(() -> BuildingComponents.WHITE_SOIL_WALL, Blocks.WHITE_SOIL_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> WHITE_SOIL_WALL_QUARTER = ITEMS.registerItem("white_soil_wall_quarter", properties -> new BuildingComponentItem(() -> BuildingComponents.WHITE_SOIL_WALL_QUARTER, Blocks.WHITE_SOIL_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RAMMED_SOIL_WALL = ITEMS.registerItem("rammed_soil_wall", properties -> new BuildingComponentItem(() -> BuildingComponents.RAMMED_SOIL_WALL, Blocks.RAMMED_SOIL_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RAMMED_SOIL_WALL_QUARTER = ITEMS.registerItem("rammed_soil_wall_quarter", properties -> new BuildingComponentItem(() -> BuildingComponents.RAMMED_SOIL_WALL_QUARTER, Blocks.RAMMED_SOIL_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> BAMBOO_WALL_BONES = ITEMS.registerItem("bamboo_wall_bones", properties -> new BuildingComponentItem(() -> BuildingComponents.BAMBOO_WALL_BONES, Blocks.BAMBOO_BONES_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> BAMBOO_WALL_BONES_QUARTER = ITEMS.registerItem("bamboo_wall_bones_quarter", properties -> new BuildingComponentItem(() -> BuildingComponents.BAMBOO_WALL_BONES_QUARTER, Blocks.BAMBOO_BONES_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_PLANKS_WALL = ITEMS.registerItem("red_planks_wall", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_PLANKS_WALL, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_PLANKS_WALL_QUARTER = ITEMS.registerItem("red_planks_wall_quarter", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_PLANKS_WALL_QUARTER, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_ROOF_EDGE_PLANKS = ITEMS.registerItem("red_roof_edge_planks", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_ROOF_EDGE_PLANKS, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> GOLD_ROOF_EDGE_PLANKS_DECORATION = ITEMS.registerItem("gold_roof_edge_planks_decoration", properties -> new BuildingComponentItem(() -> BuildingComponents.GOLD_ROOF_EDGE_PLANKS_DECORATION, Blocks.GOLD_STRUCTURAL_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_HANGING_FISH_PIG_EYE = ITEMS.registerItem("red_hanging_fish_pig_eye", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_HANGING_FISH_PIG_EYE, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> GREEN_STRAIGHT_BAR_WINDOW = ITEMS.registerItem("green_straight_bar_window", properties -> new BuildingComponentItem(() -> BuildingComponents.GREEN_STRAIGHT_BAR_WINDOW, Blocks.GREEN_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> GREEN_STRAIGHT_BAR_WINDOW_QUARTER = ITEMS.registerItem("green_straight_bar_window_quarter", properties -> new BuildingComponentItem(() -> BuildingComponents.GREEN_STRAIGHT_BAR_WINDOW_QUARTER, Blocks.GREEN_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_LATTICED_WINDOW = ITEMS.registerItem("red_latticed_window", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_LATTICED_WINDOW, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_LATTICED_WINDOW_QUARTER = ITEMS.registerItem("red_latticed_window_quarter", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_LATTICED_WINDOW_QUARTER, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_PLANKS_FLOOR = ITEMS.registerItem("red_planks_floor", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_PLANKS_FLOOR, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_PLANKS_FLOOR_QUARTER = ITEMS.registerItem("red_planks_floor_quarter", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_PLANKS_FLOOR_QUARTER, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_LATTICED_CEILING_WHITE = ITEMS.registerItem("red_latticed_ceiling_white", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_LATTICED_CEILING_WHITE, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_LATTICED_CEILING_WHITE_QUARTER = ITEMS.registerItem("red_latticed_ceiling_white_quarter", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_LATTICED_CEILING_WHITE_QUARTER, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_BENDED_STICKERS = ITEMS.registerItem("red_bended_stickers", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_BENDED_STICKERS, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_FROG_LEGS_LIKED_STICKER = ITEMS.registerItem("red_frog_legs_liked_sticker", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_FROG_LEGS_LIKED_STICKER, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_STEEP_RAFTER = ITEMS.registerItem("red_steep_rafter", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_STEEP_RAFTER, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_SMOOTH_RAFTER = ITEMS.registerItem("red_smooth_rafter", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_SMOOTH_RAFTER, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_RAFTER_END = ITEMS.registerItem("red_rafter_end", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_RAFTER_END, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_RAFTER_CONNECTOR = ITEMS.registerItem("red_rafter_connector", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_RAFTER_CONNECTOR, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_THIN_RAFTER = ITEMS.registerItem("red_thin_rafter", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_THIN_RAFTER, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> RED_THIN_RAFTER_CONNECTOR = ITEMS.registerItem("red_thin_rafter_connector", properties -> new BuildingComponentItem(() -> BuildingComponents.RED_THIN_RAFTER_CONNECTOR, Blocks.RED_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> SPRUCE_RAFTER_PLANKS = ITEMS.registerItem("spruce_rafter_planks", properties -> new BuildingComponentItem(() -> BuildingComponents.SPRUCE_RAFTER_PLANKS, Blocks.SPRUCE_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> SPRUCE_RAFTER_PLANKS_QUARTER = ITEMS.registerItem("spruce_rafter_planks_quarter", properties -> new BuildingComponentItem(() -> BuildingComponents.SPRUCE_RAFTER_PLANKS_QUARTER, Blocks.SPRUCE_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> WHITE_RAFTER_PLANKS = ITEMS.registerItem("white_rafter_planks", properties -> new BuildingComponentItem(() -> BuildingComponents.WHITE_RAFTER_PLANKS, Blocks.WHITE_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> WHITE_RAFTER_PLANKS_QUARTER = ITEMS.registerItem("white_rafter_planks_quarter", properties -> new BuildingComponentItem(() -> BuildingComponents.WHITE_RAFTER_PLANKS_QUARTER, Blocks.WHITE_WOOD_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> CYPRESS_ROOF = ITEMS.registerItem("cypress_roof", properties -> new BuildingComponentItem(() -> BuildingComponents.CYPRESS_ROOF, Blocks.CYPRESS_SKIN_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> CYPRESS_ROOF_CORNER = ITEMS.registerItem("cypress_roof_corner", properties -> new BuildingComponentItem(() -> BuildingComponents.CYPRESS_ROOF_CORNER, Blocks.CYPRESS_SKIN_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> CYPRESS_ROOF_EDGE = ITEMS.registerItem("cypress_roof_edge", properties -> new BuildingComponentItem(() -> BuildingComponents.CYPRESS_ROOF_EDGE, Blocks.CYPRESS_SKIN_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> CYPRESS_ROOF_EDGE_CORNER = ITEMS.registerItem("cypress_roof_edge_corner", properties -> new BuildingComponentItem(() -> BuildingComponents.CYPRESS_ROOF_EDGE_CORNER, Blocks.CYPRESS_SKIN_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> CYPRESS_ROOF_HALF = ITEMS.registerItem("cypress_roof_half", properties -> new BuildingComponentItem(() -> BuildingComponents.CYPRESS_ROOF_HALF, Blocks.CYPRESS_SKIN_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> CYPRESS_ROOF_QUARTER = ITEMS.registerItem("cypress_roof_quarter", properties -> new BuildingComponentItem(() -> BuildingComponents.CYPRESS_ROOF_QUARTER, Blocks.CYPRESS_SKIN_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> CYPRESS_ROOF_EDGE_LAYER_BOTTOM = ITEMS.registerItem("cypress_roof_edge_layer_bottom", properties -> new BuildingComponentItem(() -> BuildingComponents.CYPRESS_ROOF_EDGE_LAYER_BOTTOM, Blocks.CYPRESS_SKIN_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> CYPRESS_ROOF_EDGE_LAYER_TOP = ITEMS.registerItem("cypress_roof_edge_layer_top", properties -> new BuildingComponentItem(() -> BuildingComponents.CYPRESS_ROOF_EDGE_LAYER_TOP, Blocks.CYPRESS_SKIN_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> CYPRESS_ROOF_QUARTER_CORNER = ITEMS.registerItem("cypress_roof_quarter_corner", properties -> new BuildingComponentItem(() -> BuildingComponents.CYPRESS_ROOF_QUARTER_CORNER, Blocks.CYPRESS_SKIN_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> CYPRESS_ROOF_TOP = ITEMS.registerItem("cypress_roof_top", properties -> new BuildingComponentItem(() -> BuildingComponents.CYPRESS_ROOF_TOP, Blocks.CYPRESS_SKIN_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> FLAT_TERRACOTTA_TILE_ROOF = ITEMS.registerItem("flat_terracotta_tile_roof", properties -> new BuildingComponentItem(() -> BuildingComponents.FLAT_TERRACOTTA_TILE_ROOF, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    ...
    public static final DeferredItem<? extends Item> ROUND_TERRACOTTA_TILE_1_1 = ITEMS.registerItem("round_terracotta_tile_1_1", properties -> new BuildingComponentItem(() -> BuildingComponents.ROUND_TERRACOTTA_TILE_1_1, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    ...
    public static final DeferredItem<? extends Item> ROUND_TERRACOTTA_TILE_1_2 = ITEMS.registerItem("round_terracotta_tile_1_2", properties -> new BuildingComponentItem(() -> BuildingComponents.ROUND_TERRACOTTA_TILE_1_2, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    ...
    public static final DeferredItem<? extends Item> ROUND_TERRACOTTA_TILE_1_4 = ITEMS.registerItem("round_terracotta_tile_1_4", properties -> new BuildingComponentItem(() -> BuildingComponents.ROUND_TERRACOTTA_TILE_1_4, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    ...
    public static final DeferredItem<? extends Item> ROUND_TERRACOTTA_TILE_FLAT = ITEMS.registerItem("round_terracotta_tile_flat", properties -> new BuildingComponentItem(() -> BuildingComponents.ROUND_TERRACOTTA_TILE_FLAT, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    ...
    public static final DeferredItem<? extends Item> TERRACOTTA_TILE_ROOF_EDGE = ITEMS.registerItem("terracotta_tile_roof_edge", properties -> new BuildingComponentItem(() -> BuildingComponents.TERRACOTTA_TILE_ROOF_EDGE, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    ...
    public static final DeferredItem<? extends Item> ROUND_TERRACOTTA_TILE_END = ITEMS.registerItem("round_terracotta_tile_end", properties -> new BuildingComponentItem(() -> BuildingComponents.ROUND_TERRACOTTA_TILE_END, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> TERRACOTTA_TILE_ROOF_TOP = ITEMS.registerItem("terracotta_tile_roof_top", properties -> new BuildingComponentItem(() -> BuildingComponents.TERRACOTTA_TILE_ROOF_TOP, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> ROOF_TOP_TILES_PILE_1_1 = ITEMS.registerItem("roof_top_tiles_pile_1_1", properties -> new BuildingComponentItem(() -> BuildingComponents.ROOF_TOP_TILES_PILE_1_1, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    ...
    public static final DeferredItem<? extends Item> ROOF_TOP_TILES_PILE_1_2 = ITEMS.registerItem("roof_top_tiles_pile_1_2", properties -> new BuildingComponentItem(() -> BuildingComponents.ROOF_TOP_TILES_PILE_1_2, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    ...
    public static final DeferredItem<? extends Item> ROOF_TOP_TILES_PILE_1_4 = ITEMS.registerItem("roof_top_tiles_pile_1_4", properties -> new BuildingComponentItem(() -> BuildingComponents.ROOF_TOP_TILES_PILE_1_4, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    ...
    public static final DeferredItem<? extends Item> ROOF_TOP_TILES_PILE_FLAT = ITEMS.registerItem("roof_top_tiles_pile_flat", properties -> new BuildingComponentItem(() -> BuildingComponents.ROOF_TOP_TILES_PILE_FLAT, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    ...
    public static final DeferredItem<? extends Item> ROOF_TOP_TILES_PILE_START = ITEMS.registerItem("roof_top_tiles_pile_start", properties -> new BuildingComponentItem(() -> BuildingComponents.ROOF_TOP_TILES_PILE_START, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> ONI_TILE_1 = ITEMS.registerItem("oni_tile_1", properties -> new BuildingComponentItem(() -> BuildingComponents.ONI_TILE_1, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> ONI_TILE_1_OBLIQUE = ITEMS.registerItem("oni_tile_1_oblique", properties -> new BuildingComponentItem(() -> BuildingComponents.ONI_TILE_1_OBLIQUE, Blocks.TERRACOTTA_TILE_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
    public static final DeferredItem<? extends Item> GOLD_PIN_FIN = ITEMS.registerItem("gold_pin_fin", properties -> new BuildingComponentItem(() -> BuildingComponents.GOLD_PIN_FIN, Blocks.GOLD_DECO_COMPONENT, properties), properties -> properties.useBlockDescriptionPrefix());
