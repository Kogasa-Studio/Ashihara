...
public class AdditionalModels
{
    ...
    public static final BuildingComponentModelResourceLocation WHITE_WOOD_8_LEG_ALTAR_TABLE_THIN = register("block/furnitures/white_wood_8_leg_altar_table_thin");
    public static final BuildingComponentModelResourceLocation WHITE_WOOD_8_LEG_ALTAR_TABLE_THIN_SHORT = register("block/furnitures/white_wood_8_leg_altar_table_thin_short");
    public static final BuildingComponentModelResourceLocation WHITE_WOOD_8_LEG_ALTAR_TABLE_THIN_TALL = register("block/furnitures/white_wood_8_leg_altar_table_thin_tall");
