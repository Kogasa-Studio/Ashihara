...
public class BuildingComponents
{
    ...
    new Wall
        ...
        List.of(Items.BAMBOO_WALL_BONES.toStack(), Items.RAMMED_SOIL.toStack(4), Items.LIME_POWDER.toStack(4)),
        null,
        null,
        null,
        null,
    ...
    (
        ...
        Blocks.WHITE_SOIL_COMPONENT,
        List.of(Items.BAMBOO_WALL_BONES_QUARTER.toStack(), Items.RAMMED_SOIL.toStack(), Items.LIME_POWDER.toStack()),
        null,
        null,
        null,
        null,
    ...
    (
        ...
        List.of(Items.BAMBOO_WALL_BONES.toStack(), Items.RAMMED_SOIL.toStack(4)),
    ...
    (
        ...
        Shapes.box(0.25, 0, 0.40625, 0.75, 0.5, 0.59375),
        Blocks.RAMMED_SOIL_COMPONENT,
        List.of(Items.BAMBOO_WALL_BONES_QUARTER.toStack(), Items.RAMMED_SOIL.toStack()),
